...
Level 3 (Component) view: zoomed into ONE container — the recon-service
API — showing its internal Spring components grouped by stereotype
(controllers, security, services, repositories, Kafka producer/consumer).
UI, Postgres, and Kafka appear only as external references at the edge,
not as components.
