...
Level 1 (Context) view: ReconX as a single box, its human actors, and the
external systems it integrates with. No internal containers, services, or
databases appear at this level — that detail belongs in the Level 2
(Container) diagram.
